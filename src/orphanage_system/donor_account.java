...
String user,name,address,contact;
    /**
    ...
    public donor_account(String user) {
        ...
        try {
            ...
            ResultSet rs=st.executeQuery("select * from donor_reg where username='"+user+"'");
            rs.next();
            name=rs.getString(1);
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(2, 85, 139));
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Donor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select","Chairs","Tables", "Pillow","Plates", "Bed", "Cloths" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String no_item=jTextField1.getText();
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/orphanage","root","");
