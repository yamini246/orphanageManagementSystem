 ...
 * @author asus
 */
public class Adopt_reg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Huband/Wife Name:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String conpass=jPasswordField2 .getText().toString();
        String date=String.valueOf(java.time.LocalDate.now());
        String hwname=jTextField5.getText();
        if(name.equals("")||address.equals("")||contact.equals("")||username.equals("")||pass.equals("")||conpass.equals(""))
        {
        ...
        else
        {
            ...
            try {
                ...
                if(hwname.equals(""))
                {
                    jTextField5.setText("NOT MARRIED");
                    hwname="NOT MARRIED";
                } 
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/orphanage","root","");
                PreparedStatement st=con.prepareStatement("insert into adopter_reg(name,hwname,address,contact,username,password)values(?,?,?,?,?,?)");
                st.setString(1,name);
                st.setString(2,hwname);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Adopt_reg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
